...
import { BS, BID, MAT } from '../constants.js';
...
export const BLOCK_DEFS = [
  ...
  // ── ARMOR ─────────────────────────────────────────────────────────────────
  {
    ...
    cost: { [MAT.IRON_PLATE]: 2 }, canDelete: true,
    effect: {},
    draw(ctx, w, h) {
  ...
  // ── ENGINE ────────────────────────────────────────────────────────────────
  {
    ...
    cost: { [MAT.IRON_PLATE]: 2, [MAT.COPPER_WIRE]: 1 }, canDelete: true,
    effect: { thrust: 900 },
    draw(ctx, w, h) {
  ...
  // ── WEAPON ────────────────────────────────────────────────────────────────
  {
    ...
    cost: { [MAT.IRON_PLATE]: 1, [MAT.COPPER_WIRE]: 1 }, canDelete: true,
  ...
  // ── DRILL ─────────────────────────────────────────────────────────────────
  {
    ...
    cost: { [MAT.IRON_PLATE]: 2, [MAT.TITANIUM_ALLOY]: 1 }, canDelete: true,
  ...
  // ── GENERATOR ─────────────────────────────────────────────────────────────
  {
    ...
    cost: { [MAT.COPPER_WIRE]: 2, [MAT.CRYSTAL_LENS]: 1 }, canDelete: true,
    effect: {},
    draw(ctx, w, h) {
  ...
  // ── SHIELD ────────────────────────────────────────────────────────────────
  {
    ...
    cost: { [MAT.CRYSTAL_LENS]: 2, [MAT.COPPER_WIRE]: 1 }, canDelete: true,
  ...
  // ── RADAR ─────────────────────────────────────────────────────────────────
  {
    ...
    cost: { [MAT.COPPER_WIRE]: 1, [MAT.CRYSTAL_LENS]: 1 }, canDelete: true,
  ...
  // ── DRONE HATCH ───────────────────────────────────────────────────────────
  {
    ...
    cost: { [MAT.IRON_PLATE]: 2, [MAT.COPPER_WIRE]: 2, [MAT.CRYSTAL_LENS]: 1 }, canDelete: true,
    effect: { drones: 1 },
    draw(ctx, w, h) {
